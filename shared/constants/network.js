...
export const MAINNET_DISPLAY_NAME = 'XDC Mainnet';
export const GOERLI_DISPLAY_NAME = 'Goerli';

const infuraProjectId = process.env.INFURA_PROJECT_ID;
const getRpcUrl = (network) => {
  console.log("---------Right RPC call ---------------- ", network)
  switch (network) {
    case ("testnet"):
  ...
  // return `https://rpc.${network}.infura.io/v3/${infuraProjectId}`;
  
}

export const TESTNET_RPC_URL = getRpcUrl('testnet');
export const RINKEBY_RPC_URL = getRpcUrl('rinkeby');
export const KOVAN_RPC_URL = getRpcUrl('kovan');
export const MAINNET_RPC_URL = getRpcUrl('xinfin');
export const GOERLI_RPC_URL = getRpcUrl('goerli');

export const ETH_SYMBOL = 'XDC';
export const WETH_SYMBOL = 'WETH';
export const TEST_ETH_SYMBOL = 'XDC';
...
export const INFURA_PROVIDER_TYPES = [TESTNET, RINKEBY, KOVAN, MAINNET, GOERLI];
